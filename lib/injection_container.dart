...
import 'package:flutter_clean_archi/core/network/network_info.dart';
...
Future<void> init() async { //on renvoie un Future car on est async, sinon ça serait simplement void
  //Features - Number Trivia
  // bloc
  sl.registerFactory(() => NumberTriviaBloc( //quand on a des streams a gérer, il faut faire un registerFactory et pas un registerSingleton. Singleton pour les éléments sans états
      concrete: sl(),
      inputConverter: sl(),
      random: sl()
    )
  ...
  // Use cases
  //lazy petmet de charger uniquement quand on en a besoin, donc meilleure gestion de la mémoire
